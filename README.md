...
@af:Function
public function f2(@af:HTTPTrigger {} http:Request req) returns @af:HTTPOutput string|error {
...
public function f3(af:Context ctx, 
                   ...
                   @af:QueueOutput { queueName: "queue1" } af:StringOutputBinding msg) returns @af:HTTPOutput string|error {
  msg.value = req;
...
@af:Function
public function f5(@af:TimerTrigger { schedule: "*/10 * * * * *" } json triggerInfo, 
                   @af:QueueOutput { queueName: "queue3" } af:StringOutputBinding msg) returns error? {
