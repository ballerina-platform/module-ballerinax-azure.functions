 ...
 * @since 2.0.0
 */
public class AzureLifecycleListener extends CompilerLifecycleListener {
    @Override
    public void init(CompilerLifecycleContext compilerLifecycleContext) {
        compilerLifecycleContext.addCodeGenerationCompletedTask(new AzureCodeGeneratedTask());
    }
}
