 ...
 * under the License.
 */
package org.ballerinax.azurefunctions.generator.handlers;
...
import org.ballerinax.azurefunctions.generator.FunctionDeploymentContext;
import org.ballerinax.azurefunctions.generator.GeneratorUtil;
import org.ballerinax.azurefunctions.generator.ParameterHandler;
...
public abstract class AbstractParameterHandler implements ParameterHandler {
    ...
    private void processBinding() throws AzureFunctionsException {
        ...
        GeneratorUtil.addFunctionBinding(this.ctx, binding);
    }
