 ...
 * under the License.
 */
package org.ballerinax.azurefunctions.generator.handlers.cosmosdb;
        ...
        if (singleRecordQuery) {
            if (GeneratorUtil.isJsonType(this.variableSymbol)) {
                ...
                return GeneratorUtil
                        .createAfFunctionInvocationNode("getParsedJsonFromJsonStringFromInputData", true, params,
                        stringArg);
            } else if (GeneratorUtil.isOptionalRecordType(this.variableSymbol)) {
                PositionalArgumentNode stringArg =
                        NodeFactory.createPositionalArgumentNode(NodeFactory
                                .createBasicLiteralNode(SyntaxKind.STRING_LITERAL, NodeFactory
                                        .createLiteralValueToken(SyntaxKind.STRING_LITERAL_TOKEN,
                ...
                TypeDefinitionNode optionalTypeDefinitionNode =
                        GeneratorUtil.createOptionalTypeDefinitionNode(optionalTypeDescriptor);
                ...
                ExpressionNode checkedExpr =
                        GeneratorUtil
                                .createAfFunctionInvocationNode("getOptionalBallerinaValueFromInputData", true, params,
                                stringArg, typeDesc);
                ...
                throw new AzureFunctionsException(
                        GeneratorUtil.getAFDiagnostic(this.param.typeName().location(), "AZ0008",
            ...
            if (GeneratorUtil.isJsonType(this.variableSymbol)) {
                        ...
                        NodeFactory.createPositionalArgumentNode(NodeFactory
                                .createBasicLiteralNode(SyntaxKind.STRING_LITERAL, NodeFactory
                                        .createLiteralValueToken(SyntaxKind.STRING_LITERAL_TOKEN,
                                                ...
                                                NodeFactory.createEmptyMinutiaeList(),
                                                NodeFactory.createEmptyMinutiaeList())));
                return GeneratorUtil.createAfFunctionInvocationNode("getJsonFromInput", true, params, stringArg);
            } else if (GeneratorUtil.isRecordArrayType(this.variableSymbol)) {
                PositionalArgumentNode stringArg =
                        NodeFactory.createPositionalArgumentNode(NodeFactory
                                .createBasicLiteralNode(SyntaxKind.STRING_LITERAL, NodeFactory
                                        .createLiteralValueToken(SyntaxKind.STRING_LITERAL_TOKEN,
                ...
                TypeDefinitionNode arrayTypeDefinitionNode = GeneratorUtil
                        .createArrayTypeDefinitionNode(arrayTypeDescriptor);
                ...
                ExpressionNode checkedExpr =
                        GeneratorUtil.createAfFunctionInvocationNode("getBallerinaValueFromInputData", true, params,
                                stringArg, typeDesc);
