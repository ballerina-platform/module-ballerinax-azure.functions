...
public class HTTPTriggerParameterHandler extends AbstractParameterHandler {
    ...
    public ExpressionNode invocationProcess() throws AzureFunctionsException {
        ...
        if (GeneratorUtil.isAzurePkgType(this.variableSymbol, "HTTPRequest")) {
            ...
            return GeneratorUtil
                    .createAfFunctionInvocationNode("getHTTPRequestFromInputData", true, paramsArg, stringArg);
            ...
            return GeneratorUtil.createAfFunctionInvocationNode("getBodyFromHTTPInputData", true, paramsArg, stringArg);
        } else {
