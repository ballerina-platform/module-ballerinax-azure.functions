 ...
 * under the License.
 */
package org.ballerinax.azurefunctions.generator.handlers.timer;
...
public class TimerTriggerHandler extends AbstractParameterHandler {
    ...
    public ExpressionNode invocationProcess() throws AzureFunctionsException {
        if (GeneratorUtil.isJsonType(this.variableSymbol)) {
            ...
            return GeneratorUtil.createAfFunctionInvocationNode("getJsonFromInputData", true, paramsArg, stringArg);
        } else {
