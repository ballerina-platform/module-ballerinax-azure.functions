...
/**
 * Responsible for disallowing azure functions in submodule document.
 *
 * @since 2.0.0
 */
public class SubmoduleValidator extends NodeVisitor {
    ...
    public void visit(ImportDeclarationNode importDeclarationNode) {
        ...
        if (Constants.AZURE_FUNCTIONS_MODULE_NAME.equals(moduleName)) {
            DiagnosticInfo diagnosticInfo = new DiagnosticInfo("AZ011", "azure functions is not allowed inside" +
